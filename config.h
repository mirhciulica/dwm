...
static const int taglayouts[] = {1, 0, 0, 0, 1, 0};
...
static const char *dmenfmcmd[] = { "dmenfm", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_p,      spawn,          {.v = dmenfmcmd } },
